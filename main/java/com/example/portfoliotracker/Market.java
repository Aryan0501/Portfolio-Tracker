...
public class Market extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchEdt = findViewById(R.id.editCurrency);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(Market.this , "Something went amiss. Please try again later", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public Map<String, String> getHeaders() {
                ...
                headers.put("X-CMC_PRO_API_KEY", "98ed2abf-6112-4282-80da-f679a5c273fc");
